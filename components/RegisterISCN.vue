...
const licenseMap: { [key: string]: string | null } = {
...
const licenseOptions = Object.entries(licenseMap).map(([label, value]) => ({
  label,
  value: value || label
}))
...
const payload = computed(() => ({
  ...
  license: iscnData.value.license === 'Other' ? customLicense.value : (licenseMap[iscnData.value.license] || iscnData.value.license),
